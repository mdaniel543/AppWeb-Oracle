...
async function user(req, res) {
    const {depa} = req.body
    console.log(depa)
    sql = "SELECT p.Nombre, ap.Nombre, TO_CHAR(Fecha_Postulacion, 'DD/MM/YYYY' ) Fecha_Postulacion, ap.CUI, ap.Apellido, ap.Correo, ap.Direccion, ap.Telefono, ap.CV, ap.Planilla, dp.Depa_Puesto_ID " +
    " FROM APLICANTE ap " + 
